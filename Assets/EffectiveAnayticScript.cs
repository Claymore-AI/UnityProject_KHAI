using UnityEngine;
using TMPro; // Добавьте этот namespace для работы с TextMeshPro
using UnityEngine.Profiling; // Не забудьте добавить этот namespace для работы с Profiler

public class EffectiveAnalyticScript : MonoBehaviour
{
